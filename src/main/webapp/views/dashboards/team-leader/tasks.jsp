                ...
                <div class="proj-details">
                    ...
                    <div class="proj-actions">
                        <form action="${pageContext.request.contextPath}/DeleteTask" method="post" style="display:inline;">
                            ...
                            <button type="submit" class="proj-btn proj-danger" onclick="return confirm('Are you sure you want to delete this task?');"><i class="fas fa-trash"></i> Delete</button>
                        </form>
                        <a href="${pageContext.request.contextPath}/TeamLeaderTaskServlet?contentType=<%= contentType %>&taskFilter=<%= taskFilter %>&action=edit&taskId=<%= task.getTaskId() %>" class="proj-btn"><i class="fas fa-edit"></i> Edit</a>
                        <a href="${pageContext.request.contextPath}/TeamLeaderTaskServlet?contentType=<%= contentType %>&taskFilter=<%= taskFilter %>&action=download&taskId=<%= task.getTaskId() %>" class="proj-btn"><i class="fas fa-download"></i> Download</a>
                    </div>
                </div>
            <% } %>
    <%
        // Edit View
            ...
            Task task = (Task) request.getAttribute("taskDetails");
            String from = request.getParameter("contentType");
            String taskId = request.getParameter("taskId");
    %>
            <div class="proj-edit">
                <div class="proj-header">
                    <button class="proj-back-btn" onclick="window.location.href='${pageContext.request.contextPath}/TeamLeaderTaskServlet?contentType=<%= contentType %>&taskFilter=<%= taskFilter %>&action=view&taskId=<%= task.getTaskId() %>'"><i class="fas fa-arrow-left"></i> Back</button>
                ...
                <form action="${pageContext.request.contextPath}/TeamLeaderTaskServlet" method="post">
                    ...
                    <div class="proj-form-group">
                        ...
                        <input type="date" name="deadlineDate" value="<%= task.getDeadlineDate() != null ? task.getDeadlineDate() : "" %>" required>
                    </div>
