...
<div class="container">
    ...
    <% if (selectedProject != null) { %>
        <div class="project-details">
            ...
            <button class="back-btn" onclick="window.location.href='${pageContext.request.contextPath}/TeamLeaderProjectServlet?contentType=<%= contentType %>'">Back to Projects</button>
        </div>
    <% } else { %>
                ...
                <% if (projects != null && !projects.isEmpty()) { %>
                    <% for (Project project : projects) { %>
                        <tr>
                            ...
                            <td>
                                <a href="${pageContext.request.contextPath}/TeamLeaderProjectServlet?contentType=<%= contentType %>&projectId=<%= project.getProjectId() %>" class="view-btn">View Details</a>
                            </td>
                        </tr>
                    <% } %>
                <% } else { %>
