...
<div class="proj-list-container">
    <%
        ...
        String contentType = request.getParameter("contentType") != null ? request.getParameter("contentType") : "completed-tasks";
    ...
    <%
            ...
            // Debug output
            System.out.println("completed-tasks.jsp: completedTasks = " + (completedTasks != null ? completedTasks.size() : "null"));
    %>
            ...
            <% } else { %>
                <p class="proj-no-data"><i class="fas fa-exclamation-circle"></i> No completed tasks found.</p>
            <% } %>
    <% } %>
</div>
</body>
